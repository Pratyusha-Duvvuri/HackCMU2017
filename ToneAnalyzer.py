...
def evaluateTone(data):
     #analyze_tone(data)
    return display_results_fake(data)
...
#         results = True;#analyze_tone(data)
#         if results != False:
#             display_results_fake(results)
#             exit
#         else:
