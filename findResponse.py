...
def respond(sentence):
    ...
    D=ToneAnalyzer.evaluateTone(sentence)
    if(ToneAnalyzer.isScared(D)):
        resp="Don't worry! You can do this!"+resp
    if(ToneAnalyzer.isAngry(D)):
        resp="Keep calm and carry on. The authorities are trying their best to help."+resp
    return resp
