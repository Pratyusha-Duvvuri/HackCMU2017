...
# GREETING_RESPONSES = ["Hi!", "Hey", "*nods*", "How may I help :)"]
...
#         pronoun = "Meaw"#find_pronoun(sent)
#         noun = "Cat"#find_noun(sent)
#         adjective = "Pretty"#find_adjective(sent)
#         verb = "Runs"#find_verb(sent)
